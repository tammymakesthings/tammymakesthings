...
![LGBT Rainbow Pride Flag](/img/fw_neopixel_pride/badge_running_1.jpg)
...
![Featherwing Pinout](/img/fw_neopixel_pride/featherwing_pinout.jpg)
...
![Soldering the headers onto the Feather](/img/fw_neopixel_pride/soldering_feather.jpg)
...
![Soldering the FeatherWing](/img/fw_neopixel_pride/soldering_featherwing.jpg)

**Stack the Featherwing and Feather.** Gently squeeze to seat the pins into
the connectors on the microcontroller board.

![Stacking the boards](/img/fw_neopixel_pride/boards_stacked.jpg)
